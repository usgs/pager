...
ORANGE_FAT_LOW = (
    "Orange alert for shaking-related fatalities. Significant casualties are likely."
)
RED_FAT_LOW = ""
...
YELLOW_ECON_LOW = (
    "Yellow alert for economic losses. Some damage is possible. [GDPCOMMENT]"
)
ORANGE_ECON_LOW = (
    "Orange alert for economic losses. Significant damage is likely. [GDPCOMMENT]"
)
RED_ECON_LOW = ""
