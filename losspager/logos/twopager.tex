...
\node[above=0cm of pager.north east,anchor=south east,
  ...
  \includegraphics[scale=0.32]{[HOMEDIR]/losspager/logos/FEMA.png}
};
...
%-------------------------------------------------------------------------------
% Hazus loss estimate arrow (box is 1.75cm left of arrow)
%-------------------------------------------------------------------------------
\node[rectangle,fill=white,left=[BOXSHIFT]cm of hazbox.north east,anchor=north west,minimum width=1.45cm, minimum height=0.4cm,yshift=1.6mm]{}; 
...
\node[ntext,xshift=0.45cm,below=0.7cm of hazbox.north west,anchor=north west,
...
\node[ntext,xshift=4.62cm,below=0.7cm of hazbox.north west,anchor=north west,
...
\node[ntext,xshift=8.79cm,below=0.7cm of hazbox.north west,anchor=north west,
