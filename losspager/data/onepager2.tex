...
\node[rectangle,inner xsep=0,above=0 of pop0.north west,anchor=south west,h1]
     (poptitle){Population Exposure};
\node[fn,above=0 of pop10000.north east,anchor=south east] 
...
\node[rectangle,inner sep=0,outer sep=0,
  ...
  \includegraphics[width=13cm]
    {/Users/emthompson/pager/output/us19891018000415/version.004/exposure.pdf}
};
\node[fn,below=0 of cmap.south west,anchor=north west](mapfn1){
  PAGER content is automatically generated, and only considers losses due to 
  structural damage.
};
\node[fn,below=0 of mapfn1.south west,anchor=north west](mapfn2){
  Limitations of input data, shaking estimates, and loss models
  may add uncertainty.
};
\node[fn,font=\bf\scriptsize,below=2pt of mapfn2.south west,anchor=north west](eventurl){
...
\matrix [table,matrix of nodes,nodes in empty cells,nodes={cell},font=\tiny]
  (poptab) at (0, 18) % <------------------------------------- absolute position
{
  ...
  |[empty]|&   & None & None & None & V. Light & Light & 
      Moderate & Moderate/Heavy & Heavy & V. Heavy \\
  |[empty]|& & None & None & None & Light & Moderate & 
      Moderate/Heavy & Heavy & V. Heavy & V. Heavy \\
};
...
\node[fit=(poptab-3-1)(poptab-3-2),h3]{
  PERCEIVED~SHAKING
};
...
\node[above=0 of poptab.north west,anchor=south west,h1](exptitle){
...
\node[ntext,below=0pt of str.south west,anchor=north west,
  text width=\barwidth](strtxt){
  [STRUCTCOMMENT]
};
...
\node[h2,above=0 of citynote.north west,anchor=south west]
     (citytitle){
  Selected City Exposure
};
\node[fn,font=\bf\scriptsize,below=8mm of citytab.south east,anchor=north east](eventid){
  [EVENTID]
};
...
\node[ntext,between=strtxt.south west and citytitle.north west,
  text width=\barwidth,anchor=west,yshift=-1ex] (htab){
  [HISTORICAL_BLOCK]
};
\node[h2,above=2pt of htab.north west,anchor=south west](htitle){
...
\node[h1,above=1cm of fhist.north,
      fit={(fhist.west) (fhist.east)},
      anchor=south]{
...
\node[h1,above=1cm of ehist.north,
      fit={(ehist.west) (ehist.east)},
      anchor=south]{
...
% Impact 1 statement
\node[ntext,below=1mm of abox.north,anchor=north,
  text width=6.5cm](impact1){
  [IMPACT1]
};

% Impact 2 statement
\node[ntext,below=1.5ex of impact1.south,anchor=north,
  text width=6.5cm](impact2){
  [IMPACT2]
};
...
% Tsunami
\node[fn,above=0 of abox.north west,anchor=south west](tsunami){
  \color{red}\textbf{[TSUNAMI]}
};

% Location
\node[fn,above=0 of tsunami.north west,anchor=south west](loc){
  Location: [LAT]\degree\,[HEMILAT] [LON]\degree\,[HEMILON] Depth: [DEPTH] km
};

% Origin time
\node[fn,above=0 of loc.north west,anchor=south west,
  inner ysep=0](otime){
...
% Elapsed time
\node[fn,above=0 of abox.north east,anchor=south east](elapsed){
  [ELAPSED]};

% Version
\node[h1,above=0 of elapsed.north east,anchor=south east,
      inner sep=0,outer sep=0](version){[VERSION]};
\node[h1,above=0 of version.north east,anchor=south east,
...
\node[above=0pt of magloc.north west,anchor=south west,
