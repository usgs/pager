...
\node[h3,right=4pt of pop10000.north east,anchor=north west,
  yshift=0mm] (str){
  Structures
};
...
\node[h3,above=0 of citynote.north west,anchor=south west]
     (citytitle){
...
\node[h3,above=2pt of htab.north west,anchor=south west](htitle){
...
\node[h2,xshift=1.5cm,below=1mm of abox.north west,
      anchor=north west]{
...
\node[h2,xshift=-5mm,below=1mm of abox.north east,
      anchor=north east]{
...
\node[h3,left=1mm of scir.west,anchor=east,text width=2.5cm,
      align=right,yshift=10pt]{
  Earthquake \\ Shaking
};

\node[h3,right=1mm of scir.east,anchor=west,text width=2.5cm,
...
% Tsunami
\node[info,above=0 of abox.north west,anchor=south west](tsunami){
  \color{red}\textbf{[TSUNAMI]}
};

% Location
\node[info,above=0 of tsunami.north west,anchor=south west](loc){
...
% Elapsed time
\node[info,above=0 of abox.north east,anchor=south east](elapsed){
  [ELAPSED]};
