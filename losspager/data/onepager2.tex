...
\draw[thick] (pop0.north west) -- (cmap.south west);
\node[info,below=-1pt of cmap.south west,anchor=north west](mapfn1){
...
\node[fn,below=0pt of citytab.south west,anchor=north west]
   {bold cities appear on map.};
\node[fn,below=0pt of citytab.south east,anchor=north east]
   {(k\,=\,x1000)};


\node[fn,above=0pt of citytab.north west,anchor=south west]
     (citynote){
  from GeoNames.org
};
...
\node[h1,xshift=1mm,below=1.5mm of abox.north west,
      anchor=north west]{
...
\node[h1,xshift=0.7mm,below=1.5mm of abox.north east,
      anchor=north east]{
...
% Origin time
\node[info,above=0pt of loc.north west,anchor=south west,
  inner ysep=0](otime){
  Origin Time: [ORIGTIME] UTC ([LOCALTIME] local)
};

% Mag and location
\node[h1,above=0pt of otime.north west,anchor=south west,
  inner ysep=0](magloc){
  [MAGLOC]
};
