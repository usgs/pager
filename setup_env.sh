...
DEPARRAY=(numpy=1.12.1 scipy=0.19.0 matplotlib=1.5.3 jupyter=1.0.0 \
          ...
          pyproj=1.9.5.1 pytest=3.2.3 pytest-cov=2.5.1 \
          ...
          descartes=1.1.0 flake8=3.4.1 hypothesis=3.21.1)
...
curl --max-time 60 --retry 3 -L https://github.com/usgs/earthquake-impact-utils/archive/0.5.zip -o impact.zip
