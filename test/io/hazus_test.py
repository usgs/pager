...
def test_map():
    ...
    try:
        ...
        yellow_table = ('\\begin{tabularx}{3.4cm}{lr}\n& \\\\\n\\multicolumn'
                        '{2}{c}{\\textbf{RESTRICTED USE}} \\\\\n\\textbf'
                        '{Occupancy} & \\textbf{\\# of tags}  \\\\\n'
                        'Residential & 1k \\\\\nCommercial & 161 \\\\\n'
                        'Industrial & 30 \\\\\nEducation & 5 \\\\\n'
                        'Agriculture & 2 \\\\\nGovernment & 2 \\\\\n\\'
                        'end{tabularx}')
        ...
        loss_table = ('\\begin{tabularx}{\\barwidth}{lc*{1}{>{\\raggedleft'
                      '\\arraybackslash}X}}\n\\hline\n\\textbf{County} & '
                      '\\textbf{State} & \\textbf{Total (\\textdollar M)} '
                      ...
                      '\\\\\n\\multicolumn{2}{l}{\\textbf{Total (19 counties)}} '
                      '& \\multicolumn{1}{>{\\raggedleft}X}{\\textbf{4,643}} '
                      '\\\\\n\\hline\n\\end{tabularx}')
        ...
        injury_table = ('\\begin{tabularx}{\\barwidth}{lc*{2}{>{\\raggedleft'
                        '\\arraybackslash}X}}\n\\hline\n\\textbf{County} & '
                        ...
                        '{Union} & NJ & 536k & 10 \\\\\n\\truncate{2.4cm}'
                        '{Monmouth} & NJ & 630k & 7 \\\\\n\\multicolumn'
                        '{2}{l}{\\textbf{Total (19 counties)}} & '
                        '\\multicolumn{1}{>{\\raggedleft}X}{\\textbf'
                        '{18,517k}} & \\multicolumn{1}{>{\\raggedleft}'
                        'X}{\\textbf{447}} \\\\\n\\hline\n\\end{tabularx}')
        ...
        shelter_table = ('\\begin{tabularx}{\\barwidth}{lc*{3}{>{\\raggedleft'
                         '\\arraybackslash}X}}\n\\hline\n\\'
                         '               &                 & \\textbf{Total}'
                         '  & \\textbf{Displ}  & \\textbf{Total}  \\\\\n\\'
                         '               &                 & \\textbf{House}'
                         ' & \\textbf{House} & \\textbf{People} \\\\\n\\'
                         'textbf{County} & \\textbf{State} & \\textbf{holds}'
                         '  & \\textbf{holds}  &  \\\\\n\\hline\n\\truncate'
                         '{2.4cm}{Kings} & NY & 917k & 2k & 2k \\\\\n\\'
                         'truncate{2.4cm}{Richmond} & NY & 166k & 162 & 106'
                         ' \\\\\n\\truncate{2.4cm}{New York} & NY & 764k & '
                         '102 & 52 \\\\\n\\truncate{2.4cm}{Queens} & NY & '
                         '780k & 146 & 106 \\\\\n\\truncate{2.4cm}{Hudson}'
                         ' & NJ & 246k & 72 & 46 \\\\\n\\truncate{2.4cm}'
                         '{Union} & NJ & 188k & 44 & 36 \\\\\n\\'
                         'truncate{2.4cm}{Monmouth} & NJ & 234k & '
                         '18 & 10 \\\\\n\\multicolumn{2}{l}{\\textbf'
                         '{Total (19 counties)}} & \\multicolumn{1}'
                         '{>{\\raggedleft}X}{\\textbf{6,794k}} & '
                         '\\multicolumn{1}{>{\\raggedleft}X}{\\textbf{3k}}'
                         ' & \\multicolumn{1}{>{\\raggedleft}X}{\\textbf{2k}}'
                         ' \\\\\n\\hline\n\\end{tabularx}')
        ...
        debris_table = ('\\begin{tabularx}{\\barwidth}{l*{1}{>{\\raggedleft'
                        '\\arraybackslash}X}}\n\\hline\n\\                 '
                        '& \\textbf{Tons}      \\\\\n\\textbf{Category} & '
                        '\\textbf{(millions)} \\\\\n\\hline\nBrick / Wood '
                        '& 0.449 \\\\\nReinforced Concrete / Steel & 0.149'
                        ' \\\\\n\\textbf{Total} & \\textbf{0.598} \\\\\n&'
                        '  \\\\\n&  \\\\\n\\textbf{Truck Loads (@25 tons/'
                        'truck)} & \\textbf{23,908} \\\\\n\\end{tabularx}')
